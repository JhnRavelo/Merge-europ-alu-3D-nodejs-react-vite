        ...
        <section id="contact" className="s-contact target-section">
            ...
            <div className="row contact-main" data-aos="fade-up">
                ...
                <div className="d__flex">
                    ...
                    >
                        <ul>
                            <li><pre>Andraharo : 034 03 11 786</pre></li>
                            <li><pre>Tamatave  : 034 56 64 786</pre></li>
                            <li><pre>Majunga   : 034 07 80 786</pre></li>
                            <li><pre>Nosy Be   : 034 11 80 786</pre></li>
                        </ul>
                    </div>
                    ...
                    >
                        <li>
                            <a><i className="fa fa-facebook float_up mr-7"></i></a>
                        </li>
                        <li>
                            <a><i className="fa fa-twitter float_up mr-5"></i></a>
                        </li>
                        <li>
                            <a><i className="fa fa-linkedin float_up"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
